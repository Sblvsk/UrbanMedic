...
from medic.views import DoctorViewSet, ExerciseViewSet, PatientViewSet
...
urlpatterns = [
    ...
    path(
        "exercises_by_patient/", ExerciseViewSet.as_view({"get": "exercises_by_patient"}), name="exercises-by-patient"
    ),
